function [ Gz ] = ProjectionAlgorithm ( u, y, na, nb, d, gamma, alpha, Ts, Plot )
% this function is used to estimate the parameter of discrate the transfer function
% unsing Projection Algorithm
%% Coded by
...
for i=4:length(y)
    ...
    theta_hat(:,i)=theta_hat(:,i-1)+gamma*phiT(i,:)'/(alpha+phiT(i,:)*phiT(i,:)')*(y(i)-phiT(i,:)*theta_hat(:,i-1));
end
