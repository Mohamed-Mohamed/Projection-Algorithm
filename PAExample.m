...
gamma=1; % parameter   > 0  && < 2
alpha=0.1; % parameter   > 0
%% output signal
y(1)=0;
for k=1:length(u)-1
...
[ Gz1 ] = ProjectionAlgorithm ( u, y, 1, 1, 0, gamma, alpha, T, [Plot 1 2] )
%% 2 st order estimation
[ Gz2 ] = ProjectionAlgorithm ( u, y, 2, 1, 1, gamma, alpha, T, [Plot 3 4] )
%% 3 st order estimation
[ Gz3 ] = ProjectionAlgorithm ( u, y, 3, 1, 1, gamma, alpha, T, [Plot 5 6] )
